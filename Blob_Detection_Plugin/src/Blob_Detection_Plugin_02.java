 ...
 */
public class Blob_Detection_Plugin_02 implements PlugInFilter{
     ImagePlus imp;
    ...
    public void run(ImageProcessor ip) {
        ImageProcessor villi = ip.getMask();
       
        BufferedImage img = villi.getBufferedImage();
        
        ImagePlus roi = new ImagePlus("ROI", img);
        ImageWindow roiWindow = new ImageWindow(roi);
